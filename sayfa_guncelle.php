...
if($_GET[kayit]==1){
	...
	if(!$hata){
		...
		konu_kısalt='$_POST[konu_kisalt]',
		konu_bölümü='$_POST[konu_bolumu]',
		icerik='$_POST[icerik]'
...
<input type="hidden" name="sayfa" value="<?php
echo $bilgi[id]
?>"/>
<?php
if($hata){
...
<p class="isimclasi">İsim:<br /><input id="submit" type="text" name="isim" value="<?php
echo $bilgi[isim]
?>"/>
</p>
<br />
...
<p class="isimclasi">Konu Bölümü:<br /><input id="submit" type="text" name="konu_bolumu" value="<?php
echo $bilgi[konu_bölümü]
?>	"/>
</p>
<br />
